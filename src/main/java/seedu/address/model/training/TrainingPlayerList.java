 ...
 */
public class TrainingPlayerList implements Iterable<Person> {
    public static final String MESSAGE_CONSTRAINTS = "%s is not a player!";

    private final UniquePersonList uniquePersonList = new UniquePersonList();

    public TrainingPlayerList(List<Person> personList) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TrainingPlayerList)) {
            return false;
        }

        TrainingPlayerList otherTrainingPlayerList = (TrainingPlayerList) other;
        return uniquePersonList.equals(otherTrainingPlayerList.uniquePersonList);
    }
