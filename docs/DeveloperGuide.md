...
`Main`](https://github.com/AY2526S2-CS2103-F08-2/tp/blob/master/src/main/java/seedu/address/Main.java) and [
`MainApp`](https://github.com/AY2526S2-CS2103-F08-2/tp/blob/master/src/main/java/seedu/address/MainApp.java)) is in
...
`Ui.java`](https://github.com/AY2526S2-CS2103-F08-2/tp/blob/master/src/main/java/seedu/address/ui/Ui.java)

![Structure of the UI Component](images/UiClassDiagramWithEvent.png)

The UI consists of a `MainWindow` that is made up of parts e.g.`CommandBox`, `ResultDisplay`, `PersonListPanel`,
`StatusBarFooter`, `EventListPanel`, etc. All these, including the `MainWindow`, inherit from the abstract `UiPart` class which captures
the commonalities between classes that represent parts of the visible GUI.

The `UI` component uses the JavaFx UI framework. The layout of these UI parts are defined in matching `.fxml` files that
are in the `src/main/resources/view` folder. For example, the layout of the [
`MainWindow`](https://github.com/AY2526S2-CS2103-F08-2/tp/blob/master/src/main/java/seedu/address/ui/MainWindow.java)
is specified in [
`MainWindow.fxml`](https://github.com/AY2526S2-CS2103-F08-2/tp/blob/master/src/main/resources/view/MainWindow.fxml)
...
**API** : [
`Logic.java`](https://github.com/AY2526S2-CS2103-F08-2/tp/blob/master/src/main/java/seedu/address/logic/Logic.java)
...
**API** : [
`Model.java`](https://github.com/AY2526S2-CS2103-F08-2/tp/blob/master/src/main/java/seedu/address/model/Model.java)
...
**API** : [
`Storage.java`](https://github.com/AY2526S2-CS2103-F08-2/tp/blob/master/src/main/java/seedu/address/storage/Storage.java)
